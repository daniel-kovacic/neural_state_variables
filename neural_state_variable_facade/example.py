...
if __name__ == "__main__":
    ...
    # loads the corresponding untrained dynamics prediction autoencoder depending on the chosen dimension
    ...
    # save the training progress. The training duration needs to be adjusted to balance accuracy and training duration
    ...
    # this is used to approximate the (neural) state dimension and stored inside the dataset_info object
    ...
    # new datasets are created from the latent encoding
    ...
    # optionally a save path can be added to save the training progress
